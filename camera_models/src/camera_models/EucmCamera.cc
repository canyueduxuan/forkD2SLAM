...
EucmCamera::Parameters::Parameters(const std::string& cameraName,
                                   int w, int h,
                                   double xi,
                                   double k1, double k2,
                                   double p1, double p2,
...
double&
EucmCamera::Parameters::xi(void)
{
    return m_xi;
}

double&
EucmCamera::Parameters::k1(void)
{
    return m_k1;
}

double&
EucmCamera::Parameters::k2(void)
{
    return m_k2;
}

double&
EucmCamera::Parameters::p1(void)
{
    return m_p1;
}

double&
EucmCamera::Parameters::p2(void)
{
    return m_p2;
}

double&
EucmCamera::Parameters::gamma1(void)
{
    return m_gamma1;
}

double&
EucmCamera::Parameters::gamma2(void)
{
    return m_gamma2;
}

double&
EucmCamera::Parameters::u0(void)
{
    return m_u0;
}

double&
EucmCamera::Parameters::v0(void)
{
    return m_v0;
}

double
EucmCamera::Parameters::xi(void) const
{
    return m_xi;
}

double
EucmCamera::Parameters::k1(void) const
{
    return m_k1;
}

double
EucmCamera::Parameters::k2(void) const
{
    return m_k2;
}

double
EucmCamera::Parameters::p1(void) const
{
    return m_p1;
}

double
EucmCamera::Parameters::p2(void) const
{
    return m_p2;
}

double
EucmCamera::Parameters::gamma1(void) const
{
    return m_gamma1;
}

double
EucmCamera::Parameters::gamma2(void) const
{
    return m_gamma2;
}

double
EucmCamera::Parameters::u0(void) const
{
    return m_u0;
}

double
EucmCamera::Parameters::v0(void) const
{
    return m_v0;
}

EucmCamera::EucmCamera(const std::string& cameraName,
...
bool
EucmCamera::Parameters::readFromYamlFile(const std::string& filename)
{
...
void
EucmCamera::Parameters::writeToYamlFile(const std::string& filename) const
{
...
std::ostream&
operator<< (std::ostream& out, const EucmCamera::Parameters& params)
{
...
Camera::ModelType
EucmCamera::modelType(void) const
{
    return mParameters.modelType();
}

const std::string&
EucmCamera::cameraName(void) const
{
    return mParameters.cameraName();
}

int
EucmCamera::imageWidth(void) const
{
    return this->width;
}

int
EucmCamera::imageHeight(void) const
{
    return this->height;
}

void
EucmCamera::estimateIntrinsics(const cv::Size& boardSize,
                               ...
                               const std::vector< std::vector<cv::Point2f> >& imagePoints)
{
    ...
    if (gamma0 <= 0.0 && minReprojErr >= std::numeric_limits<double>::max())
    {
        std::cout << "[" << params.cameraName() << "] "
                  << "# INFO: EucmCamera model fails with given data. " << std::endl;
 ...
 */
void
EucmCamera::liftSphere(const Eigen::Vector2d& p, Eigen::Vector3d& P) const
{
 ...
 */
void
EucmCamera::liftProjective(const Eigen::Vector2d& p, Eigen::Vector3d& P) const
{
    double mx_d, my_d,mx2_d, mxy_d, my2_d, mx_u, my_u;
    double rho2_d, rho4_d, radDist_d, Dx_d, Dy_d, inv_denom_d;
    //double lambda;
 ...
 */
void
EucmCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p) const
{
    double norm = P.norm();
    double d = sqrt(this->beta * (P(0) * P(0) + P(1) * P(1)) + P(2) * P(2));
    p << this->fx * P(0) / (this->alpha * d + (1 - this->alpha) * P(2)) + this->cx,
    this->fy * P(1) / (this->alpha * d + (1 - this->alpha) * P(2)) + this->cy;
}
 ...
 */
void
EucmCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p,
 ...
 */
void
EucmCamera::undistToPlane(const Eigen::Vector2d& p_u, Eigen::Vector2d& p) const
{
    Eigen::Vector2d p_d;
 ...
 */
void
EucmCamera::distortion(const Eigen::Vector2d& p_u, Eigen::Vector2d& d_u) const
{
    double k1 = mParameters.k1();
    double k2 = mParameters.k2();
    double p1 = mParameters.p1();
 ...
 */
void
EucmCamera::distortion(const Eigen::Vector2d& p_u, Eigen::Vector2d& d_u,
...
void
EucmCamera::initUndistortMap(cv::Mat& map1, cv::Mat& map2, double fScale) const
{
...
cv::Mat
EucmCamera::initUndistortRectifyMap(cv::Mat& map1, cv::Mat& map2,
                                    float fx, float fy,
                                    cv::Size imageSize,
                                    float cx, float cy,
                                    cv::Mat rmat) const
...
int
EucmCamera::parameterCount(void) const
{
    return 9;
}

const EucmCamera::Parameters&
EucmCamera::getParameters(void) const
{
    return mParameters;
}

void
EucmCamera::setParameters(const EucmCamera::Parameters& parameters)
{
...
void
EucmCamera::readParameters(const std::vector<double>& parameterVec)
{
...
void
EucmCamera::writeParameters(std::vector<double>& parameterVec) const
{
...
void
EucmCamera::writeParametersToYamlFile(const std::string& filename) const
{
    mParameters.writeToYamlFile(filename);
}

std::string
EucmCamera::parametersToString(void) const
{
