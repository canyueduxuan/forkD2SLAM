...
class CrestereoLogger: public nvinfer1::ILogger{
...
class CrestereoTrt{
 public:
  CrestereoTrt(bool show_info):show_info_(show_info){};
  ~CrestereoTrt();
 ...
 public:
  ...
  std::vector<CrestereoExcutor> executors_;
  std::shared_ptr<nvinfer1::ICudaEngine> nv_engine_ptr_ = nullptr;
  CrestereoLogger logger_;
  bool show_info_;
};
